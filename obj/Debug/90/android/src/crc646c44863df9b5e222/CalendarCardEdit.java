...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LifeNoteApp.CalendarCardEdit, LifeNoteApp", CalendarCardEdit.class, __md_methods);
	}


	public CalendarCardEdit ()
	{
		super ();
		if (getClass () == CalendarCardEdit.class)
			mono.android.TypeManager.Activate ("LifeNoteApp.CalendarCardEdit, LifeNoteApp", "", this, new java.lang.Object[] {  });
	}
